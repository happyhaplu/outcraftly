...
## Current Status
✅ Coolify installed and running at: http://<YOUR_SERVER_IP>:8000
...
1. Go to: http://<YOUR_SERVER_IP>:8000/security/api-tokens
...
- Ensure domain DNS points to <YOUR_SERVER_IP>
